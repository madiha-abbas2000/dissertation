...
las1 = laspy.read ("/home/s2695955/diss/data/NR8931_10PPM_LAZ_ScotlandNationalLiDAR.laz")
las2 = laspy.read ("/home/s2695955/diss/data/NR8932_10PPM_LAZ_ScotlandNationalLiDAR.laz")
...
print(f"Point classifications: {np.unique(las1.classification)}") # 3,4and 5 are low/medium/high vegetation so perfect for FHD and VDR 
